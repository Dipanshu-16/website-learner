...
const { isPresent, isValidEmail, isValidPassword, isValidName, isValidPhone, isValidTitle } = require("../middleware/validation")
...
const login = async function (req, res) {
    try {
        ...
        let token = jwt.sign({ userId: user["_id"] }, "websitelearner", { expiresIn: "10m" })
